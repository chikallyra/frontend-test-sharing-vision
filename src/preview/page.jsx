...
export default function Preview() {
  ...
  const posts = [
    { id: 1, title: 'Belajar Next.js', content: 'Isi konten...', status: 'Publish' },
    { id: 2, title: 'React Hooks', content: 'Isi konten...', status: 'Publish' },
    { id: 3, title: 'Draft Artikel', content: 'Isi konten...', status: 'Drafts' },
    { id: 4, title: 'Tailwind CSS', content: 'Isi konten...', status: 'Publish' },
    { id: 5, title: 'Node JS Guide', content: 'Isi konten...', status: 'Publish' },
  ];
